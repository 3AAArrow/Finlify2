          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                type="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-emerald-800/30 placeholder-gray-500 text-white bg-emerald-900/50 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm"
